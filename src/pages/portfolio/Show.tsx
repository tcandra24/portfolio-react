            ...
            <div className="items-center py-10 md:flex md:h-[400px] md:py-0">
              <div className="heading relative mb-0 md:w-[725px]">
                ...
                <p className="relative mt-7 font-medium text-[#BBC0D0] before:absolute before:top-0 before:h-full before:w-1 before:bg-primary ltr:pl-8 ltr:before:left-0 rtl:pr-8 rtl:before:right-0">
                  ...
                  developed by Vietnamese studio Sky Mavis, known for its
                  in-game economy which uses Ethereum-based cryptocurrencies.
                  Players of Axie Infinity collect and mint NFTs which represent
        ...
        <div className="container">
              ...
              >
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <feGaussianBlur
                            stdDeviation="25"
                            result="effect1_foregroundBlur_866_3412"
                          />
                        </filter>
                      </defs>
                    </svg>
                ...
                <li className="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]">
                  <div>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M0 15C0 12.24 2.24 10 5 10H9.99999V20H5C2.24 20 0 17.76 0 15Z"
                        fill="#A259FF"
                      />
                      <path
                        d="M0 5C0 2.24 2.24 0 5 0H9.99999V9.99999H5C2.24 9.99999 0 7.75999 0 5Z"
                        fill="#F24E1E"
                      />
                      <path
                ...
                <li className="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]">
                  <div>
                    ...
                    >
                      <path
                        d="M2.20085 26.8972L0 0L26.2838 0.0540514L23.9567 26.8972L13.2411 30L2.20085 26.8972Z"
                        fill="#E34F26"
                      />
                      <path
                        d="M13.2388 27.4023V2.56152L24.0626 2.59756L22.1325 24.8225L13.2388 27.4023Z"
                        fill="#EF652A"
                      />
                      <path
                ...
                <li className="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]">
                  <div>
                    ...
                    >
                      <path
                        d="M27.8261 0H34.7826L17.3913 30L0 0H13.3043L17.3913 6.95652L21.3913 0H27.8261Z"
                        fill="#41B883"
                      />
                      <path
                        d="M0 0L17.3913 30L34.7826 0H27.8261L17.3913 18L6.86957 0H0Z"
                        fill="#41B883"
                      />
                      <path
                        d="M6.86926 0L17.391 18.087L27.8258 0H21.391L17.391 6.95652L13.304 0H6.86926Z"
                        fill="#35495E"
                      />
                    </svg>
                  </div>
          ...
          <div className="py-14 md:py-20">
            ...
            <ul className="list-disc space-y-4 font-semibold leading-6 ltr:ml-[18px] rtl:mr-[18px] md:text-lg ltr:md:pl-4 rtl:md:pr-4">
              ...
              <li>
                Phasellus vitae metus nec nulla sagittis lobortis sit amet vitae
                dolor.
              </li>
              <li>
              ...
              <li>
                Nullam fermentum ipsum sit amet justo convallis, quis iaculis
                massa finibus.
              </li>
              <li>
          ...
          <div className="pb-14 md:pb-20">
            ...
            <p className="relative font-semibold leading-[30px] before:absolute before:top-0 before:h-full before:w-1 before:rounded before:bg-primary ltr:pl-6 ltr:before:left-0 rtl:pr-6 rtl:before:right-0 md:text-lg">
              Mosaic is a finance tool for making better business moves —
              automating data aggregation, analysis, and financial forecasting.
              In late 2021, we partnered to help them take charge of the
              Strategic Finance category with a new brand, voice, and web
              experience. To connect with their audience of finance leaders they
              needed to look and feel like a polished, confident, no-nonsense
              brand.
            </p>
            <p className="relative mt-5 font-semibold leading-[30px] before:absolute before:top-0 before:h-full before:w-1 before:rounded before:bg-primary ltr:pl-6 ltr:before:left-0 rtl:pr-6 rtl:before:right-0 md:text-lg">
              Easily recognised by its expert tone of voice and chess-styled
              visuals, Mosaic takes after its ideal user: the less meetings,
              more doing kinda folk. Tasked with bringing this new brand to life
              online, we built an experience to catch the eye of startups
              everywhere.
            </p>
          </div>
