                ...
                <div className="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <Link to="/team" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    Team
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <Link to="/services-detail" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    UI/UX Design
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <Link to="/blog" className="inline-block transition hover:scale-110 hover:text-secondary">
                                    Blog
                                </Link>
                            </li>
                        </ul>
