...
const Header = (props: any) => {
  ...
  return (
    <header
      className={`sticky top-0 z-50 bg-black/10 transition duration-300 ${props.className}`}
    >
              ...
              <ul onClick={() => toggleMenu()}>
                ...
                >
                  <Link
                    ...
                    className={
                      ...
                      location.pathname === "/hotel-resort" ||
                      location.pathname === "/nft" ||
                      location.pathname === "/online-courses" ||
                      location.pathname === "/restaurant" ||
                      location.pathname === "/consulting" ||
                      location.pathname === "/creative-agency" ||
                      location.pathname === "/insurance" ||
                      location.pathname === "/photography" ||
                      location.pathname === "/construction" ||
                      location.pathname === "/blog-landing" ||
                      location.pathname === "/event-concert" ||
                      location.pathname === "/gym" ||
                      location.pathname === "/job-placement" ||
                      location.pathname === "/online-payments" ||
                      location.pathname === "/personal-portfolio" ||
                      location.pathname === "/portfolio-landing"
                        ? "active"
                        : ""
                    }
                  >
                  ...
                  <div className="submenu" onClick={() => toggleMenu()}>
                    <NavLink to="/crypto">Crypto Currency</NavLink>
                    <NavLink to="/modern-saas"> Modern Saas </NavLink>
                    <NavLink to="/real-estate"> Real Estate </NavLink>
                    <NavLink to="/healthcare"> Health Care </NavLink>
                    <NavLink to="/marketing">Sales Marketing</NavLink>
                    <NavLink to="/application">Application</NavLink>
                    <NavLink to="/hotel-resort">Hotel & Resort</NavLink>
                    <NavLink to="/nft">NFT Marketplace</NavLink>
                    <NavLink to="/online-courses">Online Courses</NavLink>
                    <NavLink to="/restaurant">Restaurant</NavLink>
                    <NavLink to="/consulting">Consulting</NavLink>
                    <NavLink to="/creative-agency">Creative Agency</NavLink>
                    <NavLink to="/insurance">Insurance</NavLink>
                    <NavLink to="/photography">Photography</NavLink>
                    <NavLink to="/construction">Construction</NavLink>
                    <NavLink to="/blog-landing">Blog</NavLink>
                    <NavLink to="/event-concert">
                      Event Concert
                    ...
                    <NavLink to="/job-placement">
                      Job Placement
                      <span className="ml-1 whitespace-nowrap rounded bg-gradient-to-r from-[#ef4444] to-[#f97316] px-1.5 py-0.5 text-[10px] font-bold uppercase text-white">
                        New
                      </span>
                    </NavLink>
                    <NavLink to="/online-payments">
                      Online Payments
                      <span className="ml-1 whitespace-nowrap rounded bg-gradient-to-r from-[#ef4444] to-[#f97316] px-1.5 py-0.5 text-[10px] font-bold uppercase text-white">
                        New
                      </span>
                ...
                <li>
                  <NavLink
                    to="/portfolio"
                    className={
                      location.pathname === "/portfolio-detail" ? "active" : ""
                    }
                  >
                    Portfolio
                  </NavLink>
                ...
                <li>
                  <NavLink
                    to="/services"
                    className={
                      location.pathname === "/services-detail" ? "active" : ""
                    }
                  >
                    Service
                  </NavLink>
              ...
              <li>
                <button
                  ...
                  onClick={() =>
                    dispatch(
                      toggleDirection(
                        `${themeConfig.direction === "rtl" ? "ltr" : "rtl"}`
                      )
                    )
                  }
                >
              ...
              <li>
                <button
                  ...
                  onClick={() =>
                    dispatch(
                      toggleTheme(
                        `${themeConfig.theme === "light" ? "dark" : "light"}`
                      )
                    )
                  }
                >
                  ...
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    className={`${
                      themeConfig.theme === "light" ? "hidden" : ""
                    }`}
                  >
                    <path
